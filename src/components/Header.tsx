...
const [open, setOpen] = useState(false)
  return (
    <div className=" md:fixed top-0  w-screen pr-5 flex justify-end items-center h-14 border-b border-gray-300 bg-gray-100">
      <ul className="flex space-x-4 items-center text-gray-800 text-sm font-light cursor-pointer">
        ...
        {/* dropdown */}
        <li className="flex items-center relative" onClick={()=>setOpen(!open)}>
          ...
          <div className={`${open? '':'hidden'} absolute top-9 -right-4 w-28`}>
